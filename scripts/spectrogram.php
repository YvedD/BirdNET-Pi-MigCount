...
<img id="spectrogramimage" style="max-width:944px;width:100%;height:auto;display:none;margin:0 auto;background:#000;" src="/spectrogram.png?nocache=<?php echo $time;?>">
