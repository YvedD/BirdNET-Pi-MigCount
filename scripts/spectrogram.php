...
<img id="spectrogramimage" style="max-width:472px;width:50%;height:auto;display:none;margin:0 auto;background:#000;" src="/spectrogram.png?nocache=<?php echo $time;?>">
